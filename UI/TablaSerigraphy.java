...
public class TablaSerigraphy extends javax.swing.JFrame {
    ...
    private PuenteDBV puenteborrar;
    private PuenteDBV puenteactualizar;
    ...
    public TablaSerigraphy() {
        ...
        puenteborrar = new PuenteDBV();
        puenteactualizar = new PuenteDBV();
        cargarTabla();
        actualizarTabla();
    }
    ...
    private void btnModificar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificar2ActionPerformed
        ...
        puenteactualizar.puenteActualizar(Order, Nombre, Hechos);
        actualizarTabla();
    ...
    private void actualizarTabla(){
        DefaultTableModel modeloTabla = (DefaultTableModel) tblSerigraphy.getModel();
        puenteactualizar.puenteActualizar(modeloTabla);    }
